...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Blox Fruit | https://www.facebook.com/hung8121          [LY HOANG HUNG]"
    ...
    UserText.Text = "Lý Hoàng Hưng Hub"
...
local Library = Update:Window("Lý Hoàng Hưng Hub","",Enum.KeyCode.RightControl);

local NguyenTien = Library:AddTab("Thông Tin","4483345998")
local Main = Library:AddTab("Chính","4483345998")
local M = Library:AddTab("Vật phẩm","4483345998")
local Ss = Library:AddTab("Chỉ số","4483345998")
local RaceV4 = Library:AddTab("Tộc V4","4483345998")
local P = Library:AddTab("PVP","4483345998")
local R = Library:AddTab("Raid & tập kích","4483345998")
local T = Library:AddTab("Dịch chuyển","4483345998")
local S = Library:AddTab("Cửa hàng","4483345998")
...
NguyenTien:AddButton("Zl Chủ Script",function()
setclipboard("https://zalo.me/0867973915")
Notif.New("Copying To Clipboard Done🎉", 3)
end)
...
---- Trang Chủ
Main:AddSeperator("Cài Đặt Farm")
...
Main:AddDropdown("Tấn công nhanh Delay", AttackList,function(MakoGay)
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("Auto bật tộc V4",false,function(value)
       ...
       Main:AddToggle("Auto đặt điểm hồi sinh",true,function(value)
    _G.Set = value
end)
...
Main:AddToggle("Tấn công nhanh ",true,function(value)
   ...
   Main:AddToggle("Farm Quái gần nhất",_G.AutoFarmNearest,function(value)
...
if _G.ChestBypass then
    ...
    Main:AddButton("Dịch chuyển nhanh đến đảo bánh",function()
        if BypassTP then
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:AddToggle("Farm Tất Cả Boss Trong Sever",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("Nhận Nhiệm Vụ Boss(Thử nghiệm)",false,function(value)
    _G.Auto_Quest_Boss = value
    end)
    
    Main:AddToggle("Farm Tất Cả Boss Hop",_G.AutoAllBossHop,function(value)
...
spawn(function()
    ...
    Main:AddSeperator("Cài đặt Farm 2")
...
Main:AddToggle("Xoá Thông báo",false,function(NamfonGay)
...
Main:AddToggle("Xoá Âm Thanh Và Tăng Cấp",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    Main:AddToggle("Xoá Tấn Công",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
    ...
    spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        Main:AddToggle("Trắng Màn Hình",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddToggle("Quái Tàn Hình",_G.inv,function(value)
    _G.inv = value
    ...
    Main:AddSeperator("Cài Đặt Farm Quái")
    ...
    Main:AddSeperator("Cài Đặt Farm Mastery")
    
    _G.Kill_At = 50

    Main:AddSlider("Giết Quái%",1,100,25,function(value)

        _G.Kill_At = value
    end)
    
 
    Main:AddToggle("Chiêu Z",true,function(value)
        _G.SkillZ = value
    end)
 
    
    Main:AddToggle("Chiêu X",true,function(value)
        _G.SkillX = value
    end)
    
    Main:AddToggle("Chiêu C",true,function(value)
        _G.SkillC = value
    end)
    
     Main:AddToggle("Chiêu V",true,function(value)
        _G.SkillV = value
    end)
    
    M:AddSeperator("Thế Giới")

    if World1 then
        M:AddToggle("Auto Nhiệm Vụ Sea 2",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        ...
        M:AddToggle("Auto Nhiệm Vụ Sea 3",_G.AutoThirdSea,function(value)
    ...
    Mirragecheck:Set('🏝️: Đã Xuất Hiện Đảo Bí Ẩn :)')
    else
      Mirragecheck:Set('❌: Chưa Xuất Hiện Đảo Bí Ẩn :( ' )end
            end
        end)
end)

Mirragecheck = M:AddLabel("")
M:AddToggle("Tới Đảo Bí Ẩn",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            M:AddButton("Dịch Chuyển NPC Bán Fruit Trên Đảo Bí Ẩn", function()
                TweenNpc()
                end)
    ...
    M:AddToggle("Triệu Hồi Đảo Bí Ẩn",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
M:AddToggle("Nhặt Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    M:AddToggle("Auto Lấy Superhuman",_G.AutoSuperhuman,function(value)
    ...
    M:AddToggle("Auto Lấy DeathStep",_G.AutoDeathStep,function(value)
    ...
    M:AddToggle("Auto Lấy Sharkman Karate",_G.AutoSharkman,function(value)
    ...
    M:AddToggle("Auto Lấy Electric Claw",_G.AutoElectricClaw,function(value)
    ...
    M:AddToggle("Auto Lấy Dragon Talon",_G.AutoDragonTalon,function(value)
    ...
    M:AddToggle("Auto lấy GodHuman",_G.Auto_God_Human,function(value)
...
M:AddToggle("Farm Răng Nanh Ma Cà Rồng",false,function(value)
BjirVampire = value
...
spawn(function()
    ...
    M:AddToggle("Farm Vật Chất Kì Dị",_G.AutoEctoplasm,function(value)
    ...
    M:AddToggle("Farm Nước Mắt Huyền Bí",false,function(value)
_G.Makori_gay = value
...
spawn(function()
    ...
    M:AddToggle("Farm Quặng Nham Thạch",_G.Makori_gay,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Cánh Thiên Thần",_G.Makori_gay,function(value)
_G.Auto_Wing = value
...
spawn(function()
    ...
    M:AddToggle("Farm Kim Loại",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Bột Cacao",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Vảy Rồng",false,function(value)
Dragon_Scale = value
...
spawn(function()
    ...
    M:AddToggle("Farm Thuốc Súng",false,function(value)
Gunpowder = value
StopTween(Gunpowder)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Đuôi Cá Sea 3",false,function(value)
Fish = value
StopTween(Fish)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Răng Nhỏ",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle("Đổi Sever Farm",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
    
    M:AddSeperator(" Sea Beast ")
 
    M:AddToggle('Tấn Công Sea Beast', false, function(value)
    ...
    spawn(function()
        ...
        M:AddToggle('Tấn Công Thuyền Ma', _G.KillGhostShip, function(value)
...
M:AddToggle('Tấn Công Sea Beast Hop', false, function(value)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
                FrozenIsland:Set('✅: Đảo Băng Xuất Hiện :)')
            else
                FrozenIsland:Set('❌: Chưa Có Đảo Băng :(')
            end
        end
    end)
end)
...
M:AddToggle('Dịch Chuyển Đảo Băng [CHỈ CẦN CÓ ĐẢO]', false, function(value)
...
M:AddToggle("Auto Tấn Công Terrorshark",_G.Makori_gay,function(value)
...
M:AddToggle("Auto Tấn Công Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    M:AddToggle("Auto Tấn Công Piranha",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        M:AddToggle('Auto Tấn Công Thuyền Ma', _G.bjirFishBoat, function(value)
...
M:AddToggle('Auto Lấy Mỏ Neo [Chỉ Cần Có Nguyên Liệu]', _G.BjirAnchorCuy, function(state)
...
spawn(function()
    ...
    M:AddToggle("Auto Vùng Sấm Sét ",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
spawn(function()
   ...
   M:AddSeperator("Farm Thông Thạo")
    
    M:AddToggle("Farm Thông Thạo Fruit",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Farm Thông Thạo Súng",_G.AutoFarmGunMastery,function(value)
    ...
    M:AddToggle("Auto Lấy Buddy Sword",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    M:AddToggle("Auto Lấy Buddy Sword Hop",_G.AutoBudySwordHop,function(value)
    ...
    M:AddToggle("Auto Kiếm Law", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    M:AddToggle("Auto Kiếm Law Hop", _G.AutoOderSwordHop,function(value)
    ...
    M:AddButton("Bắt Đầu Raid Law",function()
        if World2 then
            ...
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                        FM:Set("🌑: Đã Full Moon 100%")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
                        FM:Set("🌒: Còn 75% Là Full")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                        FM:Set("🌓: Còn 50% Là Full")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then
                        FM:Set("🌔: Còn 25% Là Full")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then
                        FM:Set("🌖: Còn 15% Là Full")
                    else
                        FM:Set("🌕: Vui Lòng Chờ :)")
                    end
                end)
    ...
    M:AddToggle("Auto Lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
M:AddToggle("Auto Lấy Soul Guitar + Hop",false,function(value)
  _G.soulGuitarhop = value    
 end)

 M:AddSeperator("Song Đao Oden")

M:AddToggle("Auto lấy Song Đao Oden",_G.AutoCdk,function(value)
...
M:AddToggle("Auto lấy Tushita", _G.Autotushita,function(value)
         _G.Autotushita = value
        StopTween( _G.Autotushita)
    end)
    
    M:AddToggle("Auto lấy Tushita Hop", _G.Autotushitahop,function(value)
    ...
    M:AddToggle("Auto Lấy Cavander", _G.AutoCarvender,function(value)
         _G.AutoCarvender = value
        StopTween( _G.AutoCarvender)
    end)
    
    M:AddToggle("Auto lấy Carvander", _G.AutoCarvenderhop,function(value)
    ...
    M:AddSeperator("Raid Hải Tặc Pháo Đài Trên Biển")
    
    M:AddToggle("Farm Raid Hải Tặc", _G.AutoRaidPirate,function(value)
...
spawn(function()
    ...
    M:AddToggle("Auto lấy Twin Hook", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("Auto lấy Twin Hook Hop", _G.AutoTwinHook_Hop,function(value)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                EliteProgress:Set("Số Lần Giết Elite: "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
            end
        end)
    end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Elite_Hunter_Status:Set("✅: Hải Tặc Xuất Hiện!")	
				else
					Elite_Hunter_Status:Set("❌: Không Có Hải Tặc :((")	
				end
			end)
		end
	end)
	
    M:AddToggle("Giết Elite",_G.AutoElitehunter,function(value)
    ...
    M:AddToggle("Giết Elite Hop",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    M:AddSeperator("Lưỡi Hái")
    
    M:AddToggle("Auto lấy Lưỡi Hái",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    M:AddToggle("Auto lấy Lưỡi Hái Hop",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddToggle("Giết Boss Rip_indra",_G.AutoDarkDagger,function(value)
    ...
    M:AddToggle("Giết Boss Rip_indra Hop",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("Triệu Hồi Rip Indra [CHỈ CẦN CÓ CHÉN THÁNH]",false,function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
	...
	M:AddToggle("Auto lấy Dragon Trident", _G.Auto_Dragon_Trident,function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    M:AddToggle("Auto lấy Dragon Trident Hop", _G.Auto_Dragon_Trident_Hop,function(value)
	...
	M:AddToggle("Auto lấy Waden Sword", _G.Autowaden,function(value)
         _G.Autowaden = value
        StopTween( _G.Autowaden)
    end)
    
    M:AddToggle("Auto lấy Waden Sword Hop", _G.Autowadenhop,function(value)
    ...
    M:AddSeperator(" Boss Râu Xám ")
    
    M:AddToggle("Giết Râu Xám", _G.Autodoughking,function(value)
         _G.Autogay = value
        StopTween( _G.Autogay)
    end)
    
    M:AddToggle("Giết Râu Xám Hop", _G.AutodoughkingHop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddToggle("Auto lấy Pole v1", _G.Autodoughking,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Auto Lấy Pole v1 Hop", _G.AutodoughkingHop,function(value)
    ...
    M:AddToggle("Auto lấy Kính Swan",_G.AutoFarmSwanGlasses,function(value)
    ...
    M:AddToggle("Auto lấy Kính Swan Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
        _G.AutoFarmSwanGlasses_Hop = value
    end)
    
    M:AddSeperator("Sharks Saw")
    
    M:AddToggle("Auto lấy Sharks saw", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Auto lấy Shark Saw Hop", _G.AutodoughkingHop,function(value)
         _G.Autosawhop = value
    end)
    ...
    BoneCheck = M:AddLabel("Xương Của Bạn: Sea 3 ")
    
    spawn(function()
        while wait() do
            pcall(function()
                BoneCheck:Set("🦴Xương Của Bạn Là: "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)
    
    local BoneFarm = M:AddToggle("Farm Xương",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    M:AddToggle("Random Xương",_G.Auto_Random_Bone,function(value)
    ...
    M:AddToggle("Cầu Nguyện",pry,function(value)
    _G.Pray = value
    end)
    ...
    M:AddToggle("Thử Vận May",Trylux,function(value)
    _G.Trylux = value
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ObservationRange:Set("Cấp Độ Haki Quan Sát: "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
            end)
        end
    end)
    
    M:AddToggle("Farm Điểm Haki Quan Sát",_G.AutoObservation,function(value)
    ...
    M:AddToggle("Farm Điểm Haki Quan Sát Hop",_G.AutoObservation_Hop,function(value)
    ...
    M:AddToggle("Auto lấy Saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			M:AddToggle("Auto lấy Saber Hop",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    M:AddSeperator("Kiếm Zoro")
    
    M:AddToggle("Mua Kiếm Zoro",_G.AutoBuyLegendarySword,function(value)
    ...
    M:AddToggle("Mua Kiếm Zoro Hop",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    M:AddSeperator("Haki Màu")
    
    M:AddToggle("Mua Haki Màu",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    M:AddToggle("Mua Haki Màu Hop",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    M:AddToggle("Mua Mũ Lính Ngự Lâm",_G.AutoMusketeerHat,function(value)
    ...
    M:AddToggle("Auto lấy Rainbow Haki",_G.Auto_Rainbow_Haki,function(value)
    ...
    M:AddToggle("Nhiệm Vụ Citizen",_G.AutoObservationHakiV2,function(x)
    ...
    M:AddToggle("Auto lấy Rengoku",_G.AutoRengoku,function(value)
    ...
    M:AddToggle("Auto lấy Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    M:AddToggle("Auto Nhiệm Vụ Tộc (V2)",_G.Auto_EvoRace,function(value)
    ...
    M:AddToggle(" Auto nhiệm Vụ Bartlio",_G.AutoBartilo,function(value)
    ...
    M:AddToggle("Auto Cắm Đuốc",_G.AutoHolyTorch,function(value)
...
spawn(function()
	while wait() do
		...
		Fruit:Set("Trái Blox🍎: "..count)
		Chest:Set("Rương🗄️: "..count10)
		wait(5)
	end
end)
...
Fruit = Ss:AddLabel("Fruit Trái Cây")

  local Pointstat = Ss:AddLabel("Điểm Chỉ Số")
...
local Melee = Ss:AddLabel("Cận Chiến👊🏿: ")
local Defense = Ss:AddLabel("Phòng Thủ🔰: ")
local Sword = Ss:AddLabel("Kiếm🤺: ")
local Gun = Ss:AddLabel("Súng🔫: ")
local Fruit = Ss:AddLabel("Trái Blox🍎: ")

    spawn(function()
        while wait() do
            pcall(function()
                Melee:Set("Cận Chiến👊🏿: "..game.Players.localPlayer.Data.Stats.Melee.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Fruit:Set("Trái Blox🍎: "..game.Players.localPlayer.Data.Stats["Demon Fruit"].Level.Value)
            end)
        end
    end)
       
Ss:AddToggle("Auto Chỉ Số Kaitun",_G.Auto_Stats_Kaitun,function(value)
...
Ss:AddToggle("Cận Chiến",false,function(Value)
melee = Value    
end)
Ss:AddToggle("Phòng Thủ",false,function(value)
defense = value
end)
Ss:AddToggle("Kiếm",false,function(value)
sword = value
end)
Ss:AddToggle("Súng",false,function(value)
gun = value
end)
Ss:AddToggle("Trái Blox",false,function(value)
demonfruit = value
end)
...
RaceV4:AddLabel("Chỉ Hiện Khi Lên Sea 3")
end

if World3 then
    RaceV4:AddSeperator("Tộc V4")
    
RaceV4:AddButton("Dịch Chuyển Lên Đỉnh Cây Cổ Thụ",function()
  HyperCahaya(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
    end)
    
    RaceV4:AddButton("Dịch Chuyển Lên Đền Thời Gian",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
RaceV4:AddButton("Dịch Chuyển Gạt Cần",function()
  HyperCahaya(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

RaceV4:AddButton("Dịch chuyển đến Acient One (Phải ở trong Đền Thời Gian!)",function()
  HyperCahaya(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   RaceV4:AddButton("Mở Khoá Cổng.", function()
...
RaceV4:AddToggle("Cầu Thang Vô Hạn Bị Vô Hiệu Hoá", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)

 
  RaceV4:AddButton("Dịch Chuyển Đến Cửa Up v4",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    wait(.1)
  ...
  RaceV4:AddToggle("Vượt Tất Cả Ải V4",false,function(v)
  _G.AutoQuestRace = v
...
RaceV4:AddToggle("Auto Nhìn Trăng",_G.LockCamToMoon,function(value)
...
spawn(function()
  ...
  RaceV4:AddButton("Mua Nhiệm Vụ Acient One",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
    ...
    P:AddButton("Làm Mới Người Chơi",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:AddToggle("Quan Sát Người Chơi",false,function(value)
        SpectatePlys = value
    ...
    P:AddToggle("Dịch Chuyển",false,function(value)
    ...
    P:AddToggle("Auto Đánh Người Chơi",false,function(value)
    ...
    P:AddSeperator("Nhiệm Vụ Người Chơi")
    
    P:AddButton("Nhiệm Vụ Giết Người Chơi",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:AddToggle("Săn Người Chơi [Đợi Update]",false,function(value)
    ...
    P:AddToggle("Aimbot Súng",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    P:AddToggle("Aimbot Chiêu",false,function(value)
    ...
    P:AddToggle("Bật PvP Sau Khi Hồi Sinh",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    P:AddToggle("Chế Độ An Toàn",false,function(value)
        _G.Safe_Mode = value
    ...
    local TimeRaid = R:AddLabel("Vui Lòng Chờ Bất Đầu Raid :)")
    
    local Island1 = R:AddLabel(": Đảo 1")
    local Island2 = R:AddLabel(": Đảo 2")
    local Island3 = R:AddLabel(": Đảo 3")
    local Island4 = R:AddLabel(": Đảo 4")
    local Island5 = R:AddLabel(": Đảo 5")
        ...
        pcall(function()
            while wait() do
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == true then
                    ...
                    TimeRaid:Set("Vui Lòng Chờ Bất Đầu Raid :)")
                end
            end
        end)
    end)
...
spawn(function()
    ...
    R:AddToggle("Kill Aura ( UPDATE )",_G.concubu ,function(vu)
    _G.concubu  = vu
    end)
...
spawn(function()
    ...
    R:AddToggle("Chọn Raid",_G.AutoSelectDungeon,function(value)
    ...
    R:AddToggle("Auto Vào Raid",_G.Auto_StartRaid,function(value)
    ...
    R:AddSeperator("Kiếm Koko")
    
 R:AddToggle("Auto Kiếm Law", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    R:AddToggle("Auto Kiếm Law Hop", _G.AutoOderSwordHop,function(value)
         _G.AutoOderSwordHop = value
    end)
    ...
    R:AddButton("Vào Raid Boss Law",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)

    T:AddLabel("Lý Hoàng Hưng")
    T:AddSeperator("Thế Giới")
    
    T:AddButton("Dịch Chuyển Về sea 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("Dịch Chuyển Đến Sea 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("Dịch Chuyển lên Sea 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    T:AddButton("Dịch Chuyển Đến Seabeast",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    T:AddToggle("Dịch Chuyển",false,function(value)
    ...
    T:AddToggle("Dịch Chuyển",_G.TeleportNPC,function(value)
    ...
    S:AddButton("Mua Nhảy Cao [ $10,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    S:AddButton("Mua Haki Vũ Trang [ $25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    S:AddButton("Mua Tốc Biến [ $25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    S:AddButton("Mua Haki Quán Sát [ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
S:AddToggle("Auto Mua Kỹ Năng", false, function(t)
    Abilities = t
...
S:AddButton("Mua Thuyền",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat",_G.SelectBoat)
end)

    S:AddSeperator("Võ")
    
    S:AddButton("Mua Hắc Cước | $150,000 Beli ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    ...
    S:AddButton("Mua Võ Người Cá| $750,000 Beli ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    ...
    S:AddButton("Mua Tử Cước | $5,000 Frag $5,000,000  ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    ...
    S:AddButton("Đao Hải Tặc [ $1,000 Beli ]",function()
    ...
    S:AddButton("Chùy Sắt [ $25,000 Beli ]",function()
    ...
    S:AddButton("Kiếm 2 đầu [ $400,000 Beli ]",function()
    ...
    S:AddToggle("Kiếm Yama [ Elite Hunter 30 ]",_G.AutoYama,function(value)
        _G.AutoYama = value
    end)
...
S:AddButton("Reset Chỉ Số (Use 2.5K Fragments)", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Đổi Tộc (Use 3K Fragments)", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)
    --------------Accessories-----------------
    	S:AddSeperator("âš™ï¸ Phụ Kiện âš™ï¸")
    ...
    _G.SelectFruit = ""
    D:AddDropdown("Chọn Trái Blox Trong Shop",Table_DevilFruitSniper,function(value)
        _G.SelectFruit = value
    end)
    
    D:AddToggle("Auto Mua Trái Blox Trong Shop",_G.AutoBuyFruitSniper,function(value)
        _G.AutoBuyFruitSniper = value
    end)
    
        D:AddButton("Check Trái Blox Trên Đảo Bí Ẩn",function()
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddButton("Check Trái Blox Bán Trong Cửa Hàng",function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Remotes = ReplicatedStorage.Remotes
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddDropdown("Chọn Trái Cần Ăn",Table_DevilFruitSniper,function(value)
        _G.SelectFruitEat = value
    end)
    
    D:AddToggle("Auto Ăn Trái Blox",_G.AutoEatFruit,function(value)
    ...
    D:AddToggle("Auto Trái Blox Hop",_G.AutoEatFruitHop,function(value)
    ...
    D:AddToggle("Auto Random Trái Blox",_G.Random_Auto,function(value)
    ...
    D:AddButton("Random Trái Blox",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
        D:AddButton("Mở Shop Bán Trái Blox",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:AddToggle("Auto Thả Trái Blox",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:AddToggle("Auto Cất Trái Blox Vào Rương",_G.AutoStoreFruit,function(value)
...
spawn(function()
    ...
    D:AddToggle("Gom Trái Blox",_G.Grabfruit,function(value)
    _G.Grabfruit = value
    end)
    spawn(function()
			while wait(.1) do
    ...
    D:AddToggle("Dịch Chuyển Lại Trái Blox",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
    ...
    spawn(function()
        ...
        D:AddToggle("Gom Tất Cả Trái Trong Sever 75%, bị Kick",_G.BringFruitBF,function(value)
    ...
    Misc:AddButton("Đăng Nhập Lại Server",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    ...
    Misc:AddButton("Đổi Sever Ít Người",function()
    ...
    Misc:AddButton("Sao Chép Id Sever",function()
	setclipboard(tostring(game.JobId))
	end)
	
    Misc:AddTextbox("Dán Id Sever Cần Vào", true, function(value)
	_G.Job = value
	end)

	Misc:AddButton("Tham Gia Sever [THỬ NGHIỆM]",function()
	game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
	end)
	
    Misc:AddSeperator("Misc")
    
    Misc:AddButton("Mở Shop Bán Trái Blox",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Misc:AddButton("Mở Kho Đồ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    Misc:AddButton("Mở Kho Trái Blox",function()
...
Misc:AddButton("Haki Màu",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)
      
Misc:AddSeperator("Teams")
    
    Misc:AddButton("Team Hải Tặc",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:AddButton("Team Hải Quân",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
    Misc:AddSeperator("Highlight")

Misc:AddToggle("Hiển Thị Trò Chuyện Bị Tắt", _G.chat, function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Misc:AddToggle("Hiển thị bảng xếp hạng bị vô hiệu hóa", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Misc:AddToggle("Chế Độ Highlight",false,function(value)
        if value == true then
...
Misc:AddToggle("Đồ Hoạ",false,function(v)
			if v then
	...
	Misc:AddToggle("Haki 7 Màu",false,function(value)
		RainbowHaki = value
	end)

	Misc:AddToggle("Yoru 7 Màu",false,function(value)
		RainbowYoru = value
	end)
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddTextbox("Khoá Factment", "Please Type", true, function(value)
	_G.LockFragments = value
	end)
	
    Misc:AddSeperator("Hack")
    Misc:AddButton("Mở Khoá Haki",function()
...
elseif type(Ability) == 'table' then
   ...
   Misc:AddButton("Mở Khoá Tốc Biến",function()
   -- Ability [
--     Buso,Soru,Geppo-- ]
--Example
...
elseif type(Ability) == 'table' then
   ...
   Misc:AddButton("Mở Khoá Nhảy Cao",function()
-- Ability [
--     Buso,Soru,Geppo-- ]
--Example
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    Misc:AddButton("Nhìn Rộng", function()
		while wait() do
...
Misc:AddButton("Kaitun Cap", function(value)
    ...
    Misc:AddButton("Tàn Hình",function()
    ...
    Misc:AddButton("Dừng Dịch Chuyển",function()
        HyperCahaya(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
    ...
    Misc:AddButton("Sử Dụng Tất Cả Codes",function()
    ...
    Misc:AddButton("Đồ Hoạ Thấp",function()
        pcall(function()
    ...
    Misc:AddButton("Xoá Xương",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
    Misc:AddButton("Nhìn Xuyên Đêm",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    Misc:AddToggle("Xoá Sát Thương",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
...
Misc:AddSeperator("ESP MENU")
    ...
    Misc:AddToggle("ESP Trái Blox",false,function(a)
        DevilFruitESP = a
...
Misc:AddToggle("Esp Quái", false, function(nec)
    ...
    Misc:AddToggle("Né Không có Thời Gian Hồi Chiêu",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Misc:AddToggle("Auto Bật Tộc V3",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("Vô Hạn Nhảy Cao",getgenv().InfSoru,function(value)
    ...
    Misc:AddToggle("Đứng Trên Mặt Nước",true,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:AddToggle("Xuyên Địa Hình",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    ...
    Misc:AddButton("Xoá Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
